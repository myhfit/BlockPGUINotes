...
import bp.ui.scomp.BPContentsPanel;
import bp.ui.util.CommonUIOperations;
import bp.ui.util.UIUtil;
import bp.util.ClassUtil;

public class BPTodoListPanel2 extends JPanel implements BPEditor<JPanel>, BPViewer<BPMContainer<BPTodoList>>
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -6628836044361001598L;
...
//	protected BPTable<BPTodoItem> m_table;
	protected BPContentsPanel m_pnlcp;
	...
	protected void init()
	{
		...
		add(m_pnlcp, BorderLayout.CENTER);
...
//			m_table.refreshData();
	...
	public static class BPEditorFactoryTodoList2 implements BPEditorFactory
	{
